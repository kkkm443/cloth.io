        ...
        h(Tabs, { value: view, onValueChange: changeView, className: "main-tabs" },
            ...
            h("main", { className: "main" },
                ...
                h(TabsContent, { value: "guide" },
                    ...
                    h("div", { className: "guide-grid" }, [{ n: '01', icon: Camera, title: '사진과 위치를 남겨요', text: '수거함과 주변이 함께 보이는 사진을 올려 주세요. 먼저 의류수거함 사진인지 자동으로 확인하고, GPS가 있으면 위치도 불러와요.' }, { n: '02', icon: ScanLine, title: '수거함 상태를 확인해요', text: '사진 모델이 넘침, 주변 적치, 파손·노후, 양호 상태를 비교해요. 제안이 맞는지 확인하고 필요하면 직접 수정해 주세요.' }, { n: '03', icon: ClipboardList, title: '저장과 동시에 자동 접수해요', text: '마지막 단계에서 자동 작성된 민원을 확인하면 제보 저장과 함께 운영자 접수함에 등록돼요. 연계가 준비된 지역은 기관 자동 접수도 가능해요. 결과와 접수번호는 접수 내역에서 확인해요.' }].map(x => h("article", { className: "guide-card", key: x.n },
                    ...
                    h("div", { className: "guide-bottom" },
                        h("div", null,
                            ...
                            h("p", null, "\uC0AC\uC9C4 \uAC80\uC99D\uACFC \uC0C1\uD0DC \uBD84\uB958\uB294 \uBC94\uC6A9 CLIP \uBAA8\uB378\uC744 \uD65C\uC6A9\uD55C \uC2E4\uD5D8\uC801 \uC81C\uC548\uC774\uC5D0\uC694. \uC0AC\uB78C\u00B7\uC804\uBD07\uB300\u00B7\uC4F0\uB808\uAE30\uB9CC \uC788\uB294 \uC0AC\uC9C4 \uB4F1\uC740 \uBA3C\uC800 \uAC78\uB7EC\uB0B4\uACE0, \uC218\uAC70\uD568 \uC0AC\uC9C4\uC73C\uB85C \uD655\uC778\uB41C \uACBD\uC6B0\uC5D0 \uC0C1\uD0DC\uB97C \uBE44\uAD50\uD574\uC694. \uC124\uCE58 \uD5C8\uAC00 \uC5EC\uBD80, \uAD00\uB9AC \uC8FC\uCCB4, \uBD88\uBC95 \uC5EC\uBD80\uB294 \uD310\uB2E8\uD558\uC9C0 \uC54A\uC544\uC694."),
