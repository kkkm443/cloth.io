...
function InnerKeeperApp() {
    ...
    const [binEntry, setBinEntry] = useState({ tab: 'overview', postId: '', reportId: '' });
    ...
    function startReport(bin = null, done = false) { setBinEntry({ tab: 'overview', postId: '', reportId: '' }); setDraftBin(bin); setMaintenance(done); setSelectedBin(null); setSelected(null); setForm(true); }
    function openBin(bin, entry = {}) { setSelected(null); setBinEntry({ tab: 'overview', postId: '', reportId: '', ...entry }); setSelectedBin(bin.id); }
    ...
    return h("div", { className: "app-shell" },
        ...
        h("header", { className: "topbar" },
            ...
            h("button", { "aria-label": "\uC0C8 \uC81C\uBCF4", className: "btn primary header-report", onClick: () => startReport() },
                h(Plus, { size: 18 }),
                h("span", null, "\uC0C8 \uC81C\uBCF4"))),
        h(Tabs, { value: view, onValueChange: changeView, className: "main-tabs" },
            ...
            h("main", { className: "main" },
                ...
                h(TabsContent, { value: "mine" },
                    ...
                    cards),
                h(TabsContent, { value: "community" },
                    h(CommunityFeed, { onOpenBin: openBin, onFindBins: () => changeView('bins'), onReport: () => startReport() })),
                ...
                h(TabsContent, { value: "guide" },
                    h("div", { className: "page-heading" },
                        h("div", null,
                            ...
                            h("p", null, "\uD604\uC7A5\uC5D0\uC11C \uBC14\uB85C \uCD2C\uC601\uD558\uACE0, \uC0C1\uD0DC\uC640 \uC124\uCE58 \uD655\uC778 \uD544\uC694 \uC5EC\uBD80\uB97C \uD568\uAED8 \uAE30\uB85D\uD574\uC694."))),
                    h("div", { className: "guide-grid" }, [{ n: '01', icon: Camera, title: '사진과 위치를 남겨요', text: '휴대폰에서 바로 촬영하거나 앨범에서 선택할 수 있어요. 먼저 의류수거함 사진인지 자동으로 확인하고, GPS가 있으면 위치도 불러와요.' }, { n: '02', icon: ScanLine, title: '수거함 상태를 확인해요', text: '사진 모델이 넘침, 주변 적치, 파손·노후, 양호 상태를 비교해요. 제안이 맞는지 확인하고 필요하면 직접 수정해 주세요.' }, { n: '03', icon: ClipboardList, title: '저장과 동시에 자동 접수해요', text: '마지막 단계에서 자동 작성된 민원을 확인하면 제보 저장과 함께 운영자 접수함에 등록돼요. 연계가 준비된 지역은 기관 자동 접수도 가능해요. 결과와 접수번호는 접수 내역에서 확인해요.' }].map(x => h("article", { className: "guide-card", key: x.n },
                    ...
                    h("div", { className: "guide-bottom" },
                        h("div", null,
                            ...
                            h("p", null, "\uC0AC\uC9C4 \uAC80\uC99D\uACFC \uC0C1\uD0DC \uBD84\uB958\uB294 \uBC94\uC6A9 CLIP \uBAA8\uB378\uC744 \uD65C\uC6A9\uD55C \uC2E4\uD5D8\uC801 \uC81C\uC548\uC774\uC5D0\uC694. \uC0AC\uB78C\u00B7\uC804\uBD07\uB300\u00B7\uC4F0\uB808\uAE30\uB9CC \uC788\uB294 \uC0AC\uC9C4 \uB4F1\uC740 \uBA3C\uC800 \uAC78\uB7EC\uB0B4\uACE0, \uC218\uAC70\uD568 \uC0AC\uC9C4\uC73C\uB85C \uD655\uC778\uB41C \uACBD\uC6B0\uC5D0 \uC0C1\uD0DC\uB97C \uBE44\uAD50\uD574\uC694. \uACF5\uACF5\uB370\uC774\uD130\uC640 \uB9E4\uCE6D\uB418\uC9C0 \uC54A\uC740 \uC218\uAC70\uD568\uC740 \u2018\uACF5\uACF5\uC790\uB8CC \uBBF8\uB9E4\uCE6D \u00B7 \uD589\uC815 \uD655\uC778 \uD544\uC694\u2019\uB85C \uBD84\uB958\uD574 \uC124\uCE58 \uADFC\uAC70 \uD655\uC778 \uB300\uC0C1\uC73C\uB85C \uD45C\uC2DC\uD574\uC694. \uB2E4\uB9CC \uC0AC\uC9C4\uACFC \uACF5\uACF5\uB370\uC774\uD130\uB9CC\uC73C\uB85C \uBD88\uBC95 \uC5EC\uBD80\uB97C \uD655\uC815\uD558\uC9C0 \uC54A\uC544\uC694."),
                        ...
                        h("div", { className: "guide-privacy" },
                            ...
                            h("ul", null,
                                h("li", null, "\uC0AC\uC9C4 \uC120\uD0DD \uC2DC \uC0AC\uB78C\u00B7\uC5BC\uAD74\uB9CC \uC790\uB3D9\uC73C\uB85C \uAC00\uB824\uC694. \uB193\uCE5C \uBD80\uBD84\uC740 \uC800\uC7A5 \uC804 \uD655\uC778\uD558\uACE0 \uCD94\uAC00\uB85C \uAC00\uB824 \uC8FC\uC138\uC694."),
        ...
        h(BinDetail, { id: selectedBin, initialTab: binEntry.tab, focusPostId: binEntry.postId, focusReportId: binEntry.reportId, onClose: () => setSelectedBin(null), onReport: b => startReport(b, false), onMaintenance: b => startReport(b, true), onReportSelect: r => { setSelectedBin(null); setSelected(r); } }),
